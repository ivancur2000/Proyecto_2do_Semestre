            ...
            if(!empty($_POST))
            {
                if(isset($_POST['btn_registro']))
                {
                    ...
                    if(mysqli_query($conn, $alta))
                    {
                        ...
                        echo '<META HTTP-EQUIV="REFRESH" CONTENT="2;URL=http://localhost/yolitav3/system/ventas/lista_reserva.php">';
                        $venta1 = mysqli_query($conn,"UPDATE inmueble SET est_inm = '3' WHERE id_inmueble='$inmueble'");
                    }else
                    {
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <form action="lista_reserva.php" method="POST">
                            <div clas="form-group">
                                <label for="">Cliente:</label>
                                <input type="text" name="" value="<?php echo $data['nom_cli']." ".$data['ape_cli'] ?>" class="form-control"id="">
                                <input type="hidden" id="reserva" value="<?php echo $data['precio_cuota']; ?>" name="reserva">
