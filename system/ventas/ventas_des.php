<?php 
session_start(); 
$titulo = "Ventas Inactivas"; 
$ubicacion = "Ventas";
//consulta a la base de datos
require_once '../../resuorces/config/database.php';
$sql = mysqli_query($conn, "SELECT v.id_venta, u.nom_us,u.app_us,c.nom_cli,c.ape_cli,i.descripcion, v.num_cuotas, v.cuotas_pagadas FROM venta as v INNER JOIN usuario as u ON u.id_us = v.id_us INNER JOIN cliente as c ON c.id_cli = v.id_cli INNER JOIN inmueble as i ON i.id_inmueble = v.id_inmueble WHERE v.est_venta = 0");
$numero = 0;
if(isset($_GET['id']))
{
    $id_des1 = $_GET['id'];
...
{
    $id_des3 = $_GET['id2'];
    $delete = "UPDATE venta SET est_venta = 1 WHERE id_venta = $id_des3";
