...
if(!empty($_GET))
{
    ...
    }else
    {
        ...
        if(mysqli_query($conn,$del))
        {
            ...
            header('refresh:2; url=hab_inmu.php');
        }else
        {
            ...
            <table id="tabla1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <!-- cuerpo de la tabla -->
                        ...
                        <td><a class="btn btn-outline-success btn-sm" href="hab_inmu.php?id=<?php echo $data['id_inmueble']; ?>">Habilitar</a></td>
                    </tr>
                    <?php } ?>
                </tbody> 
            </table>
