            ...
            <table id="tabla1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <!-- cuerpo de la tabla -->
                        ...
                        <td><a class="btn btn-outline-success btn-sm" href="mod_inmu.php?id=<?php echo $data['id_inmueble']; ?>">Actualizar</a><a class="btn btn-outline-danger btn-sm" href="reserva_inmu.php?id=<?php echo $data['id_inmueble']; ?>">Eliminar</a><a class="btn btn-outline-primary btn-sm" href="foto_edi.php?id_inmu=<?php echo $data['id_inmueble']; ?>">Fotografias</a></td>
                    </tr>
                    <?php } ?>
                </tbody> 
            </table>
