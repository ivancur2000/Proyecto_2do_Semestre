...
if(!empty($_GET))
{
    ...
    }else
    {
        ...
        $id_in = $_GET['id'];
        $del = "UPDATE inmueble SET est_inm = '0' WHERE id_inmueble = '$id_in'";
    ...
    }else
    {
        //metodo de eliminacion logica
        $id_in = $_GET['id_vet'];
        $del = "UPDATE inmueble SET est_inm = '1' WHERE id_inmueble = '$id_in'";
        if(mysqli_query($conn,$del))
        {
...
<?php include "../sidebar/sidebar.php"; ?>   
    <div class="card">
        <div class="card-header">
            <a href="registro_inmu.php" class="btn btn-success btn-block">Registrar Inmuebles</a>
            <h4 class="card-title">Inmuebles Activos</h4>
        </div>
        <div class = "card-body">     
            <table id="tabla1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <!-- cuerpo de la tabla -->
                        ...
                        <td><a class="btn btn-outline-success btn-sm" href="mod_inmu.php?id=<?php echo $data['id_inmueble']; ?>">Actualizar</a><a class="btn btn-outline-danger btn-sm" href="cont_inmu.php?id=<?php echo $data['id_inmueble']; ?>">Eliminar</a><a class="btn btn-outline-primary btn-sm" href="cont_inmu.php?id_vet=<?php echo $data['id_inmueble']; ?>">Pasar a ventas</a></td>
                    </tr>
                    <?php } ?>
                </tbody> 
            </table>
