<?php
session_start();
$titulo = "Lista de Edificios en construccion"; 
$ubicacion = "Edificios";
//consulta a la base de datos
require_once '../../resuorces/config/database.php';
$sql = mysqli_query($conn,"SELECT * FROM edificio WHERE est_ed = '2'");
...
if(!empty($_GET))
{
    ...
    {
        $del="UPDATE edificio SET est_ed='1' WHERE id_ed = '$id'";
        if(mysqli_query($conn, $del))
        {
            $alert="Agregado a los edificios en venta";
            header('refresh:1;url=const_edi.php');
        }else
        {
...
<?php include "../sidebar/sidebar.php"; ?>  
    <div class="card">
        <div class="card-header">
            ...
            <h4 >Edificios en estado de construccion</h4>
        </div>
        <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-outline-success" href="mod_edi.php?id=<?php echo $vector['id_ed']; ?>">Actualizar</a><a class="btn btn-outline-danger" href="const_edi.php?id=<?php echo $vector['id_ed']; ?>">Listo para ventas</a><a class="btn btn-outline-primary" href="foto_edi.php?id_edificio=<?php echo $vector['id_ed']; ?>">Fotografia</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
