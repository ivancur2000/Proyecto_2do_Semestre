<?php
session_start();
$titulo = "Lista de Edificios deshabilitados"; 
$ubicacion = "Edificios";
//consulta a la base de datos
require_once '../../resuorces/config/database.php';
$sql = mysqli_query($conn,"SELECT * FROM edificio WHERE est_ed = '0'");
...
if(!empty($_GET))
{
    ...
    if($resultado == 0)
    {
        header('Location: habilitar_edi.php');
    }else
    {
        ...
        if(mysqli_query($conn, $del))
        {
            ...
            header('refresh:1;url=habilitar_edi.php');
        }else
        {
...
<?php include "../sidebar/sidebar.php"; ?>  
    <div class="card">
        <div class="card-header">
            <h4 >Edificios deshabilitados</h4>
        </div>
        <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-outline-success" href="habilitar_edi.php?id=<?php echo $vector['id_ed']; ?>">Habilitar</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
